...
Version: 1
Generated: 2026-02-18T07:14:10.903804
Owner: novasight
...
with DAG(
    ...
    catchup=False,
    max_active_runs=1,
    tags=["novasight-demo", "novasight-demo", "pyspark", "etl"],
) as dag:
    ...
    # Task: extract_users_task
    # Use native SparkSubmitOperator (preferred)
    tasks['extract_users_task'] = SparkSubmitOperator(
