"""
NovaSight Identity Domain — User Schemas
==========================================

Canonical location: ``app.domains.identity.schemas.user_schemas``
...
class RoleSchema(Schema):
    """Schema for role data (lightweight, embedded in user responses)."""
...
class UserCreateSchema(Schema):
    ...
    roles = fields.List(fields.String(), load_default=["viewer"])
...
class UserUpdateSchema(Schema):
    ...
    password = fields.String(
        load_only=True, validate=validate.Length(min=12, max=128)
    )
