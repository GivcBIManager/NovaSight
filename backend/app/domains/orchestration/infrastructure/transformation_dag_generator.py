"""
NovaSight Orchestration Domain — Transformation DAG Generator
==============================================================

Generates Airflow DAGs for dbt transformation workflows.
Triggered after ingestion DAGs complete via ExternalTaskSensor.

Canonical location: ``app.domains.orchestration.infrastructure.transformation_dag_generator``
...
class TransformationDAGGenerator:
    ...
    def generate_transformation_dag(
        ...
        Args:
            ...
            datasource: Data source configuration (DataConnection)
