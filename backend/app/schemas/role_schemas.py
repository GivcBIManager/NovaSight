...
class PermissionListSchema(Schema):
    ...
    categories = fields.Dict(keys=fields.String(), values=fields.List(fields.String()))
...
DEFAULT_ROLE_TEMPLATES = {
    "viewer": {
        ...
        "permissions": [
            "datasources.view", "connections.view", "ingestion.view",
            "models.view", "dags.view", "analytics.query",
            "dashboards.view"
        ]
    },
    "analyst": {
        ...
        "permissions": [
            "datasources.view", "connections.view", "ingestion.view",
            "models.view", "models.create", "dags.view",
