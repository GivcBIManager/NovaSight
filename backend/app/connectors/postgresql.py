"""
NovaSight PostgreSQL Connector
==============================
...
class PostgreSQLConnector(BaseConnector):
        ...
        with self._connection.cursor(cursor_factory=RealDictCursor) as cur:
            cur.execute("""
                SELECT 
                    ...
                    col_description((quote_ident(%s) || '.' || quote_ident(%s))::regclass, c.ordinal_position) as comment
    ...
    def get_row_count(self, schema: str, table: str) -> int:
        ...
        try:
            with self._connection.cursor() as cur:
                # Try to get estimate from pg_class first (faster)
                cur.execute("""
